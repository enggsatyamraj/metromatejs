...
const RoutePage = () => {
  ...
  return (
    <div className="bg-white px-6 lg-px-8 min-h-[80vh]">
      <div className=" grid mt-[100px] grid-cols-1 md:grid-cols-2">
        <div className="flex flex-col  py-6 rounded-lg">
          <div className="max-w-[500px] w-[98%] sm:w-[95%]  mx-auto">
            <h1 className="block mb-2 text-xl font-semibold text-gray-700">
              Source
            </h1>
            <input
          ...
          <div className="max-w-[500px] w-[98%] sm:w-[95%] mx-auto">
            <h1 className="block mt-3 mb-2 text-xl font-semibold text-gray-700">
              Destination
            </h1>
            <input
              className="block px-3   mx-auto w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          ...
          {loading ? (
            ...
            route.length > 0 && (
              <div className=" px-2">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-700">Route</h1>
                  {route.map((item, index) => {
                    return (
                      <div
                        className={`my-1  overflow-hidden rounded-lg px-3 py-1 flex border-[1px] border-gray-500 justify-between items-center `}
                        key={index}
                      >
                        ...
                        {item?.line && (
                          <div
                            className={`${backgroundColor(
                              item?.line
                            )} px-3 text-white py-1 rounded-lg text-sm`}
                          >
                            {item?.line && item?.line}
                          </div>
                        )}
