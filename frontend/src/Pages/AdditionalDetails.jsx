...
const AdditionalDetails = () => {
  ...
  return (
    <div className="bg-white px-6 lg:px-8 mt-[100px]">
      ...
      <div className="mt-4">
        ...
        <label
          htmlFor="about"
          className="block mt-3 text-xl font-medium leading-6 text-gray-900"
        >
          About
        </label>
        <div className="mt-2">
        ...
        <button
          ...
          className="bg-gray-600 text-white px-3 py-1 rounded-lg my-4 text-[15px]"
        >
          Update
        </button>
      </div>
