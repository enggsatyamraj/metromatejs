      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            intelligence, and an intuitively crafted user interface, creating a
            seamless and personalized urban journey that stands as a beacon of
            innovation and efficiency in the realm of metropolitan navigation.
          </p>
        </div>
